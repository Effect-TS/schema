...
describe.concurrent("Bigint", () => {
  it("clampBigint", async () => {
    ...
    await Util.expectDecodingSuccess(schema, 3n, 1n)
  ...
  it("greaterThanBigint", async () => {
    ...
    await Util.expectDecodingFailure(schema, -1n, "Expected a bigint greater than 0n, actual -1n")
    await Util.expectDecodingFailure(schema, 0n, "Expected a bigint greater than 0n, actual 0n")
  ...
  it("lessThanBigint", async () => {
    ...
    Util.expectEncodingSuccess(schema, -1n, -1n)
    await Util.expectDecodingFailure(schema, 0n, "Expected a bigint less than 0n, actual 0n")
    await Util.expectDecodingFailure(schema, 1n, "Expected a bigint less than 0n, actual 1n")
  })
  ...
  it("betweenBigint", async () => {
    ...
    await Util.expectDecodingSuccess(schema, 0n, 0n)
    Util.expectEncodingSuccess(schema, 1n, 1n)
    await Util.expectDecodingFailure(schema, 2n, "Expected a bigint between -1n and 1n, actual 2n")
  })

  it("positiveBigint", async () => {
    const schema = pipe(S.bigint, S.positiveBigint())

    await Util.expectDecodingFailure(schema, -1n, "Expected a positive bigint, actual -1n")
    await Util.expectDecodingFailure(schema, 0n, "Expected a positive bigint, actual 0n")
    Util.expectEncodingSuccess(schema, 1n, 1n)
  })
  ...
  it("negativeBigint", async () => {
    ...
    Util.expectEncodingSuccess(schema, -1n, -1n)
    await Util.expectDecodingFailure(schema, 0n, "Expected a negative bigint, actual 0n")
    await Util.expectDecodingFailure(schema, 1n, "Expected a negative bigint, actual 1n")
  })
  ...
  it("nonPositiveBigint", async () => {
    ...
    Util.expectEncodingSuccess(schema, -1n, -1n)
    await Util.expectDecodingSuccess(schema, 0n, 0n)
    await Util.expectDecodingFailure(schema, 1n, "Expected a non-positive bigint, actual 1n")
  })
})
